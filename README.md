...
1. **Bài toán thật sự mà Agent giải quyết**
2. **Cloud, On-prem hay Hybrid?**
3. **Ràng buộc Enterprise**
4. **Cost chi tiết**
   - 4.1 MVP Breakdown
   - 4.2 Growth / Scale
   - 4.3 OPEX hàng tháng
   - 4.4 Tại sao Growth rẻ hơn 80%
5. **3 Chiến lược tối ưu chi phí**
6. **Scale, Reliability & Vận hành**
7. **Track phù hợp Phase 2**
